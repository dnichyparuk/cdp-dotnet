    ...
    public class Tests {
        ...
        public Tuple<string, TimeSpan, TimeSpan> EvaluateDictionaryPerformance(IDictionary<string, int> dict) {
            ...
            TimeSpan addTime = Utils.EvaluatePerformance(() => {
                for (int i = 0; i < 1000; i++) dict.Add(i.ToString(), i);
            });
            // Get item performance
            int n;
            TimeSpan searchTime = Utils.EvaluatePerformance(() => {
                for (int i = 0; i < 1000; i++) n = dict[i.ToString()];
            });
        ...
        private IntNode CreateDeepTree() {
            IntNode root = new IntNode() { Data = 10000 };
        ...
        private IntNode CreateWideTree() {
            IntNode[] children = new IntNode[9999];
        ...
        public void DepthTraversalTree_Should_Return_Right_Result() {
            ...
            DepthTraversalTreeTest(CreateDeepTree(), Enumerable.Range(1, 10000), "DepthTraversalTree should proceed a deep tree");
            DepthTraversalTreeTest(CreateWideTree(), Enumerable.Range(1, 10000), "DepthTraversalTree should proceed a wide tree");
        }
        ...
        public void WidthTraversalTree_Should_Return_Right_Result() {
            ...
            WidthTraversalTreeTest(CreateDeepTree(), Enumerable.Range(1, 10000), "WidthTraversalTree should proceed a deep tree");
            WidthTraversalTreeTest(CreateWideTree(), Enumerable.Range(1, 10000), "WidthTraversalTree should proceed a wide tree");
        }
